...
@section('title','Movie Library System | About Us')
				...
				<div class="container">
					<div class="page">
						<div class="breadcrumbs">
							<a href="{{route('front-end.index')}}">Home</a>
							<span>About us</span>
						</div>

						<div class="row">
							<div class="col-md-4">
								<figure><img src="{{asset('assets/dummy/figure.jpg')}}" alt="figure image"></figure>
							</div>
							<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{asset('assets/dummy/person-1.jpg')}}" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{asset('assets/dummy/person-2.jpg')}}" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{asset('assets/dummy/person-3.jpg')}}" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{asset('assets/dummy/person-4.jpg')}}" alt=""></figure>
									<h2 class="team-name">Sarah Stuart</h2>

...
@section('title','Movie Library System | Single Movie')
@section('content')
				...
				<div class="container">
					<div class="page">
						...
						<div class="content">
							<div class="row">
								<div class="col-md-4">
									<figure class="movie-poster">@if (!empty($movie->photo)) <img src="{{asset('storage/images/origin/'.$movie->photo)}}" width="350" height="350"/> @else <img src="{{asset('/storage/images/origin/no-image.png')}}" /> @endif</figure>
								</div>
								<div class="col-md-8">
